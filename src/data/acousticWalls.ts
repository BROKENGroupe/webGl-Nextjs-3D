...
export const wallCeramicBrick: AcousticMaterial = {
    ...
    layers: [
        { name: "12mm lime plaster", thickness: 12.0 },
        { name: "365mm ceramic block", thickness: 365.0 },
        { name: "20mm light lime plastered", thickness: 20.0 },
    ],
    thirdOctaveBands: {
...
export const wallConcreteBlock: AcousticMaterial = {
    ...
    lightweightElement: false,
    layers: [
        { name: "15mm cement plaster", thickness: 15.0 },
        { name: "170mm hollow concrete block", thickness: 170.0 },
        { name: "15mm cement plaster", thickness: 15.0 },
    ],
    thirdOctaveBands: {
...
export const wallGypsumBoard: AcousticMaterial = {
    ...
    layers: [
        { name: "12.5mm gypsum board", thickness: 12.5 },
        { name: "75mm mineral wool", thickness: 75.0 },
        { name: "12.5mm gypsum board", thickness: 12.5 },
    ],
    thirdOctaveBands: {
...
export const wallThinBrickPartition: AcousticMaterial = {
    ...
    lightweightElement: true,
    layers: [
        { name: "70mm hollow brick", thickness: 70.0 },
        { name: "10mm plaster", thickness: 10.0 },
    ],
    thirdOctaveBands: {
...
export const wallLightWoodPanel: AcousticMaterial = {
    ...
    lightweightElement: true,
    layers: [
        { name: "18mm wood panel", thickness: 18.0 },
    ],
    thirdOctaveBands: {

...
export const EstablishmentCard: React.FC<EstablishmentCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-lg border border-gray-200 hover:border-gray-300 transition-all duration-200 hover:shadow-md relative"
    >
      {/* Imagen */}
      <div className="relative h-32">
        ...
        {/* Badges flotantes - monocromáticos */}
        <div className="absolute top-2 left-2 right-2 flex justify-between items-start">
          <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-white/80 text-gray-700 border border-gray-300">
        ...
        {/* Score general en la esquina - solo gris/negro */}
      ...
      <div className="p-3">
        ...
        <div className="mb-3">
          ...
          <p className="text-xs text-gray-500 truncate">{establishment.address}</p>
        </div>
        ...
        {/* Barras de progreso monocromáticas */}
        <motion.div
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs px-1.5 py-0.5 rounded bg-gray-200 text-gray-700">
                {getActiveStudy(establishment).status === 'completed' ? '✓'
                  : getActiveStudy(establishment).status === 'in_progress' ? 'En progreso'
                  : 'Pausado'}
              </span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          {hasStudies ? (
            <button
              ...
              className="flex items-center justify-center bg-black hover:bg-gray-900 text-white text-xs font-medium rounded-md py-2 px-2 transition-colors"
            >

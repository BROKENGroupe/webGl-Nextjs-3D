...
export const OnboardingModal: React.FC<OnboardingModalProps> = ({
  ...
  const { mutate, isPending } = useMutation({
    ...
    onSuccess: (res) => {
      ...
      //router.push(`/places/${String(res.id)}`);
      //form.reset();
    },
    onError: () => {
  ...
  const steps = [
    {
      ...
      description:
        "Gestiona y monitorea el rendimiento acústico de tus establecimientos con tecnología ISO 12354-4.",
      icon: "🎵",
      content: (
        <div className="space-y-4">
          <p className="text-gray-600">
            Nuestra plataforma te permite realizar análisis detallados de
            aislamiento sonoro, cumplir con normativas internacionales y
            optimizar el rendimiento acústico.
          </p>
    ...
    },
    {
      ...
      description:
        "Organiza tus espacios y realiza estudios acústicos profesionales.",
      icon: "🏢",
      content: (
        <div className="space-y-4">
          <p className="text-gray-600">
            Cada establecimiento puede tener múltiples estudios acústicos.
            Monitorea métricas clave como STC, IIC y cumplimiento ISO.
          </p>
    ...
    },
    {
      ...
      description:
        "Información detallada al pasar el mouse sobre las métricas.",
      icon: "📊",
      content: (
        <div className="space-y-4">
          <p className="text-gray-600">
          ...
          <div className="space-y-3">
            <div className="p-3 bg-green-50 rounded-lg">
              ...
              <p className="text-xs text-green-600 mt-1">
                💡 Pasa el mouse para ver recomendaciones
              </p>
            </div>
          </div>
        </div>
    ...
    },
    {
      ...
      description:
        "Gana insignias por excelencia en control acústico y cumplimiento normativo.",
      icon: "🏆",
      content: (
        <div className="space-y-4">
          <p className="text-gray-600">
            Nuestro sistema gamificado te motiva a mantener altos estándares
            acústicos y cumplir con las normativas internacionales.
          </p>
          <div className="space-y-3">
            <div className="flex items-center space-x-3 p-3 bg-yellow-50 rounded-lg">
              ...
              <div>
                <div className="font-semibold text-yellow-800">
                  Excelencia Acústica ISO
                </div>
                <div className="text-sm text-yellow-700">
                  Cumplimiento ≥ 95% por 6 meses
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
              ...
              <div>
                <div className="font-semibold text-blue-800">
                  Maestro del Aislamiento
                </div>
                <div className="text-sm text-blue-700">
                  STC Rating ≥ 58 dB consistente
                </div>
              </div>
            </div>
          </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-gray-600">
            Tienes acceso completo a todas las herramientas. Comienza creando tu
            primer establecimiento o importando datos existentes.
          </p>
                  ...
                  <div className="p-6">
                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option value="68f1b0f271ab8e232017fe17">
                            Biblioteca
                          </option>
                          <option value="68f1b0f271ab8e232017fe18">
                            Discoteca
                          </option>
                          <option value="68f1b0f271ab8e232017fe19">
                            Restaurante
                          </option>
                          <option value="68f1b0f271ab8e232017fe1a">Bar</option>
                          <option value="68f1b0f271ab8e232017fe1b">
                            Salón de Eventos
                          </option>
                        </select>
                      ...
                      <div>
                        <div className="flex items-center gap-3 mt-2">
                          ...
                          <input
                            ...
                            className="form-switch accent-gray-900 scale-110"
                            id="status-switch"
                          />
                          <label
                          ...
                          >
                            {form.watch("status") ? "Activo" : "Inactivo"}
                          </label>
                        </div>
                    ...
                    <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                      ...
                      <p className="text-sm text-blue-800">
                        Después de crear tu establecimiento, podrás configurar
                        parámetros acústicos detallados, realizar estudios ISO
                        12354-4 y visualizar el espacio en 3D.
                      </p>
                    </div>
                  </div>
                </>

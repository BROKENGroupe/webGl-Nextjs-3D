...
//   function handleWallContextMenu(event: any, wallIndex: number) {
...
//   // Store de plantas
//   const floorsStore = useBuildingStore(
//     (state: { floors: any[] }) => state.floors
//   );
//   const addFloor = useBuildingStore(
//     (state: { addFloor: (floor: any) => void }) => state.addFloor
//   );
...
//       console.log(
//         "🔄 ABERTURAS DETECTADAS - Recalculando análisis acústico..."
//       );
...
//       return GeometryEngine.createWallGeometry(
//         wallIndex,
//         p1,
//         p2,
//         depth,
...
//         console.log(
//           `🎯 DROP template en pared ${wallIndex} en posición ${clampedPosition.toFixed(
//             2
//           )}`
//         );
...
//     const coords =
//       planeXZCoordinates.length >= 3 ? planeXZCoordinates : coordinatesToUse;
...
//       coordinates: coords.map((c: { x: number; z: number }) => ({
//         x: c.x,
//         y: 0,
//         z: c.z,
//       })),
...
//         */}
//         {coordinatesToUse.map(
//           (coord: { x: number; z: number }, index: number) => {
...
//                     InteractionEngine.calculateDisplayPosition(
//                       opening,
//                       isBeingDragged,
//                       previewPosition,
//                       coord,
...
//                         <primitive
//                           object={MaterialService.getOpeningMaterial(
...
//             const wallMeshes = floor.walls.map(
//               (
//                 wall: {
//                   id: string;
//                   wallIndex: number;
...
//             const floorMesh = (
//               <mesh
//                 geometry={GeometryEngine.createFloorGeometry(floor.coordinates)}
//               >
//                 <meshStandardMaterial
//                   color={COLORS.wall}
//                   transparent
